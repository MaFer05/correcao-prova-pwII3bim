...
import mariaoliveira.repositories.ProfessoresRepository;
...
public class ProfessoresController {
    ...
    public String saveupdate(@RequestParam("nome") String nome, @RequestParam("id") int id, @RequestParam("componente") String componente) {
        Optional<Professor> professor = professoresRepo.findById(id);
